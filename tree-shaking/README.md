...
### After using Badge from 1.20 **61.9 kB**
...
### After adding ColorPicker from 1.20 **63.5 kB**
...
### After adding Box from 1.20 **63.6 kB**
...
### After switching to 1.21.1 **63.6 kB**
...
### After creating an additional page **5.63 kB**
